...
public class TalkToArduino {
	...
	/**
	 * A function that returns the current arduino lock.
	 * 
	 * @return 1 or 2.
	 */
	...
	/**
	 * A function that returns the current arduino status as an int.
	 * 
	...
	/**
	 * A function that returns the current arduino status as a String.
	 * 
	...
	/**
	 * A function that communicates with the arduino or a simulated arduino with random status.
	 * 
	 * @param message An input choice from the client to the arduino.
	 */
